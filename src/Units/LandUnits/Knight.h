...
class Knight : public Unit, public IArmed, public IMagical {
public:
	Knight(Player* pOwner, Fraction fraction, Map* pMap, bool isPaladin = false);
	...
	virtual void installUpgrade(const Upgrade& u) override;
