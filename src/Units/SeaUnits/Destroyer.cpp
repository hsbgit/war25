...
Destroyer::Destroyer(Player* pOwner, Fraction fraction, Map* pMap) : Unit(pOwner, fraction, pMap, 100, 10, 8, 10), IArmed(35, 0, 4) {
	// Generic behavior
	...
	m_icon = g_pRessourceManager->getIcon(PUD_ICON_ELVEN_DESTROYER, this->getFraction(), getOwner()->getColor());
	setName((fraction == Fraction::Alliance) ? "Elven Destroyer" : "Troll Destroyer");
}
