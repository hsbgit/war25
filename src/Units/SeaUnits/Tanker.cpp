...
Tanker::Tanker(Player* pOwner, Fraction fraction, Map* pMap) : Unit(pOwner, fraction, pMap, 90, 0, 4, 10) {
	// Generic behavior
	...
	m_icon = g_pRessourceManager->getIcon(PUD_ICON_HUMAN_TANKER, this->getFraction(), getOwner()->getColor());
